...
import videoBackground from '../imagem/Sal�o Pro.mp4';
      ...
      <footer className="w-full bg-bg-primary py-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center justify-center md:justify-start gap-3 text-text-muted text-sm text-center md:text-left">
            ...
            />
            <p>
              Copyright © {new Date().getFullYear()} Sal�o Pro. <br className="md:hidden" />
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            {/* Contato i9builder */}
            <a href="mailto:lucianosaints@gmail.com" className="flex items-center gap-2 text-gold hover:text-gold-light text-sm transition-colors group bg-gold/5 px-4 py-2.5 rounded-lg border border-gold/10 hover:bg-gold/10 whitespace-nowrap shadow-sm">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="font-semibold">Fale com a i9builder</span>
            </a>
